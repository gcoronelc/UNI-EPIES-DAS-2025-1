...
public class MDIView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuProcesosMatriculaV2.setText("Matricula V2");
        menuProcesosMatriculaV2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuProcesosMatriculaV2ActionPerformed(evt);
            }
        });
        menuProcesos.add(menuProcesosMatriculaV2);
   ...
   private void menuProcesosMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuProcesosMatriculaActionPerformed
       JInternalFrame view = new ProcMatriculaView();
    ...
    private void menuProcesosMatriculaV2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuProcesosMatriculaV2ActionPerformed
        JInternalFrame view = new ProcMatriculaViewV2();
        desktopPane.add(view);
        view.setVisible(true);
        try {
            view.setMaximum(true);
